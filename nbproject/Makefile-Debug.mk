...
LDLIBSOPTIONS=-L../../../gvf-master/src -L../../../gvf-master/Eigen -L../utils -L../YIN -L../utils/dist/Debug/MinGW-Windows -lutils
...
${OBJECTDIR}/GVFTester.o: GVFTester.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../gvf-master/Eigen -I../../../gvf-master/src -I../utils -MMD -MP -MF $@.d -o ${OBJECTDIR}/GVFTester.o GVFTester.cpp
